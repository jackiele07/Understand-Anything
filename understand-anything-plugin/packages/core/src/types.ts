...
// SequenceDiagram (generated by --with-flowchart)
...
// ApiEndpoint (generated by --with-api)
export interface ApiEndpoint {
  id: string;            // "api:POST:/api/investigations"
  method: "GET" | "POST" | "PUT" | "PATCH" | "DELETE" | "WS" | "gRPC";
  path: string;          // "/api/investigations"
  layerId: string;       // "layer:investigator"
  summary: string;
  auth?: string;         // "Bearer" | "ApiKey" | "None" | "DeviceToken"
  requestType?: string;  // "WorkflowExecutionRequest"
  responseType?: string; // "202 { investigationId: string }"
  filePath: string;      // "Investigator/Program.cs"
}
